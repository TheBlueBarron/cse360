...
public class PasswordEvaluator {
	 ...
	 * 
	 * @version 1.0			2025-01-24  Implemented new special characters to adhere to FSM Diagram in Step 8
	 * 
	 */
	...
	public static String evaluatePassword(String input) {
		...
		while (running) {
			...
			} else if ("~`!@#$%%^&*()_-+{}[]|:,.?/".indexOf(currentChar) >= 0) { // Implemented new special characters to adhere to FSM Diagram in Step 8.
