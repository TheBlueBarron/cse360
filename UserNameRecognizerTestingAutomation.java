...
public class UserNameRecognizerTestingAutomation {
	...
	public static void main(String[] args) {
		...
		performTestCase(10, "user.name", true);
			
		performTestCase(11, "user_name", true);
		
		performTestCase(12, "user-name", true);
		
		performTestCase(13, "username12", true);
		
		performTestCase(14, "UserName34", true);
